       ...
       MAIN-LOGIC.
                  ...
                  COMPUTE WS-VAR-001 = WS-VAR-002 * 18.
                  COMPUTE WS-VAR-002 = WS-VAR-003 * 81.
                  COMPUTE WS-VAR-003 = WS-VAR-004 - 8.
                  COMPUTE WS-VAR-004 = WS-VAR-005 + 85.
                  COMPUTE WS-VAR-005 = WS-VAR-006 - 57.
                  COMPUTE WS-VAR-006 = WS-VAR-007 * 98.
                  COMPUTE WS-VAR-007 = WS-VAR-008 - 94.
                  COMPUTE WS-VAR-008 = WS-VAR-009 * 98.
                  COMPUTE WS-VAR-008 = 88.
                  COMPUTE WS-VAR-009 = WS-VAR-010 * 58.
                  COMPUTE WS-VAR-010 = WS-VAR-011 - 13.           STOP RUN.
