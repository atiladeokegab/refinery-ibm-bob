       ...
       MAIN-LOGIC.
                  ...
                  COMPUTE WS-VAR-000 = 63.
                  COMPUTE WS-VAR-001 = WS-VAR-002 + 5.
                  COMPUTE WS-VAR-001 = 71.
                  COMPUTE WS-VAR-002 = WS-VAR-003 + 6.
                  COMPUTE WS-VAR-002 = 11.
                  COMPUTE WS-VAR-003 = WS-VAR-004 + 68.
                  COMPUTE WS-VAR-003 = 68.
                  COMPUTE WS-VAR-004 = WS-VAR-005 + 26.
                  COMPUTE WS-VAR-005 = WS-VAR-006 - 32.
                  COMPUTE WS-VAR-006 = WS-VAR-007 - 42.
                  COMPUTE WS-VAR-007 = WS-VAR-008 + 10.
                  COMPUTE WS-VAR-008 = WS-VAR-009 * 25.
                  COMPUTE WS-VAR-009 = WS-VAR-010 - 75.
                  COMPUTE WS-VAR-010 = WS-VAR-011 + 47.
                  COMPUTE WS-VAR-011 = WS-VAR-012 * 14.
                  COMPUTE WS-VAR-012 = WS-VAR-013 * 86.           STOP RUN.
