       ...
       PROCEDURE DIVISION.
       MAIN-LOGIC.
                  COMPUTE WS-VAR-000 = WS-VAR-001 - 66.
                  COMPUTE WS-VAR-001 = WS-VAR-002 - 13.
                  ...
                  COMPUTE WS-VAR-005 = 42.
                  COMPUTE WS-VAR-006 = WS-VAR-007 - 11.
                  COMPUTE WS-VAR-006 = 50.
                  COMPUTE WS-VAR-007 = WS-VAR-008 * 8.
                  COMPUTE WS-VAR-007 = 95.
                  COMPUTE WS-VAR-008 = WS-VAR-009 - 17.           STOP RUN.
