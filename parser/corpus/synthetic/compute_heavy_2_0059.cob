       ...
       MAIN-LOGIC.
                  ...
                  COMPUTE WS-VAR-001 = WS-VAR-002 - 10.
                  COMPUTE WS-VAR-002 = WS-VAR-003 - 1.
                  COMPUTE WS-VAR-003 = WS-VAR-004 - 49.
                  COMPUTE WS-VAR-004 = WS-VAR-005 - 15.
                  COMPUTE WS-VAR-005 = WS-VAR-006 * 45.
                  COMPUTE WS-VAR-006 = WS-VAR-007 * 29.
                  COMPUTE WS-VAR-007 = WS-VAR-008 * 18.
                  COMPUTE WS-VAR-008 = WS-VAR-009 * 46.
                  COMPUTE WS-VAR-009 = WS-VAR-010 - 71.
                  COMPUTE WS-VAR-009 = 37.
                  COMPUTE WS-VAR-010 = WS-VAR-011 * 65.
                  COMPUTE WS-VAR-010 = 17.
                  COMPUTE WS-VAR-011 = WS-VAR-012 + 7.
                  COMPUTE WS-VAR-012 = WS-VAR-013 + 12.
                  COMPUTE WS-VAR-012 = 69.
                  COMPUTE WS-VAR-013 = WS-VAR-014 - 84.
                  COMPUTE WS-VAR-013 = 10.           STOP RUN.
