       ...
       PROCEDURE DIVISION.
       MAIN-LOGIC.
                  COMPUTE WS-VAR-000 = WS-VAR-001 * 4.
                  COMPUTE WS-VAR-000 = 81.
                  COMPUTE WS-VAR-001 = WS-VAR-002 * 66.
                  COMPUTE WS-VAR-001 = 38.
                  COMPUTE WS-VAR-002 = WS-VAR-003 + 95.
                  COMPUTE WS-VAR-002 = 48.
                  COMPUTE WS-VAR-003 = WS-VAR-004 * 52.
                  COMPUTE WS-VAR-004 = WS-VAR-005 * 58.
                  COMPUTE WS-VAR-005 = WS-VAR-006 + 85.
                  COMPUTE WS-VAR-006 = WS-VAR-007 + 73.
                  COMPUTE WS-VAR-007 = WS-VAR-008 + 5.
                  COMPUTE WS-VAR-007 = 5.
                  COMPUTE WS-VAR-008 = WS-VAR-009 - 35.
                  COMPUTE WS-VAR-008 = 62.
                  COMPUTE WS-VAR-009 = WS-VAR-010 * 80.
                  COMPUTE WS-VAR-010 = WS-VAR-011 - 3.
                  COMPUTE WS-VAR-011 = WS-VAR-012 + 31.           STOP RUN.
