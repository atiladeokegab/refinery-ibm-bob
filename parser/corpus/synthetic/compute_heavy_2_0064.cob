       ...
       MAIN-LOGIC.
                  ...
                  COMPUTE WS-VAR-002 = 59.
                  COMPUTE WS-VAR-003 = WS-VAR-004 * 48.
                  COMPUTE WS-VAR-003 = 20.
                  COMPUTE WS-VAR-004 = WS-VAR-005 - 88.
                  COMPUTE WS-VAR-004 = 29.
                  COMPUTE WS-VAR-005 = WS-VAR-006 - 89.
                  COMPUTE WS-VAR-006 = WS-VAR-007 - 89.
                  COMPUTE WS-VAR-006 = 10.
                  COMPUTE WS-VAR-007 = WS-VAR-008 + 31.
                  COMPUTE WS-VAR-008 = WS-VAR-009 - 54.
                  COMPUTE WS-VAR-008 = 10.
                  COMPUTE WS-VAR-009 = WS-VAR-010 - 15.           STOP RUN.
