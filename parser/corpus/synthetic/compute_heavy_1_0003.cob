       ...
       MAIN-LOGIC.
                  ...
                  COMPUTE WS-VAR-001 = WS-VAR-002 * 55.
                  COMPUTE WS-VAR-002 = WS-VAR-003 * 81.
                  COMPUTE WS-VAR-003 = WS-VAR-004 * 29.
                  COMPUTE WS-VAR-004 = WS-VAR-005 * 51.
                  COMPUTE WS-VAR-005 = WS-VAR-006 * 42.
                  COMPUTE WS-VAR-006 = WS-VAR-007 * 8.
                  COMPUTE WS-VAR-006 = 28.
                  COMPUTE WS-VAR-007 = WS-VAR-008 - 7.
                  COMPUTE WS-VAR-007 = 10.
                  COMPUTE WS-VAR-008 = WS-VAR-009 - 40.
                  COMPUTE WS-VAR-009 = WS-VAR-010 * 54.
                  COMPUTE WS-VAR-009 = 2.           STOP RUN.
