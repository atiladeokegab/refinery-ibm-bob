       ...
       MAIN-LOGIC.
                  ...
                  COMPUTE WS-VAR-001 = WS-VAR-002 * 17.
                  COMPUTE WS-VAR-002 = WS-VAR-003 - 51.
                  COMPUTE WS-VAR-003 = WS-VAR-004 - 19.
                  COMPUTE WS-VAR-003 = 78.
                  COMPUTE WS-VAR-004 = WS-VAR-005 * 54.
                  COMPUTE WS-VAR-004 = 72.
                  COMPUTE WS-VAR-005 = WS-VAR-006 * 18.
                  COMPUTE WS-VAR-005 = 5.
                  COMPUTE WS-VAR-006 = WS-VAR-007 + 17.
                  COMPUTE WS-VAR-006 = 59.
                  COMPUTE WS-VAR-007 = WS-VAR-008 + 82.
                  COMPUTE WS-VAR-008 = WS-VAR-009 + 91.
                  COMPUTE WS-VAR-009 = WS-VAR-010 * 30.
                  COMPUTE WS-VAR-010 = WS-VAR-011 + 33.
                  COMPUTE WS-VAR-011 = WS-VAR-012 * 80.
                  COMPUTE WS-VAR-012 = WS-VAR-013 * 33.           STOP RUN.
