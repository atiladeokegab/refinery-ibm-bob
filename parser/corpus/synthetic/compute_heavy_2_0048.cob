       ...
       PROCEDURE DIVISION.
       MAIN-LOGIC.
                  COMPUTE WS-VAR-000 = WS-VAR-001 + 84.
                  COMPUTE WS-VAR-001 = WS-VAR-002 + 25.
                  COMPUTE WS-VAR-002 = WS-VAR-003 + 58.
                  COMPUTE WS-VAR-003 = WS-VAR-004 * 24.
                  COMPUTE WS-VAR-004 = WS-VAR-005 + 88.
                  COMPUTE WS-VAR-005 = WS-VAR-006 - 91.
                  COMPUTE WS-VAR-006 = WS-VAR-007 * 62.
                  COMPUTE WS-VAR-007 = WS-VAR-008 + 36.
                  COMPUTE WS-VAR-008 = WS-VAR-009 + 26.           STOP RUN.
