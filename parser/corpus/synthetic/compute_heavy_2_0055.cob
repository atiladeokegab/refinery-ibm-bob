       ...
       MAIN-LOGIC.
                  ...
                  COMPUTE WS-VAR-001 = WS-VAR-002 * 96.
                  COMPUTE WS-VAR-001 = 32.
                  COMPUTE WS-VAR-002 = WS-VAR-003 + 43.
                  COMPUTE WS-VAR-003 = WS-VAR-004 + 28.
                  COMPUTE WS-VAR-003 = 32.
                  COMPUTE WS-VAR-004 = WS-VAR-005 * 40.
                  COMPUTE WS-VAR-004 = 17.
                  COMPUTE WS-VAR-005 = WS-VAR-006 * 77.
                  COMPUTE WS-VAR-005 = 99.
                  COMPUTE WS-VAR-006 = WS-VAR-007 * 1.
                  COMPUTE WS-VAR-007 = WS-VAR-008 + 75.
                  COMPUTE WS-VAR-008 = WS-VAR-009 - 31.
                  COMPUTE WS-VAR-009 = WS-VAR-010 * 47.
                  COMPUTE WS-VAR-010 = WS-VAR-011 * 8.
                  COMPUTE WS-VAR-011 = WS-VAR-012 * 33.
                  COMPUTE WS-VAR-011 = 82.
                  COMPUTE WS-VAR-012 = WS-VAR-013 * 73.
                  COMPUTE WS-VAR-013 = WS-VAR-014 + 31.
                  COMPUTE WS-VAR-014 = WS-VAR-015 + 71.           STOP RUN.
