       ...
       MAIN-LOGIC.
                  ...
                  COMPUTE WS-VAR-003 = WS-VAR-004 + 63.
                  COMPUTE WS-VAR-004 = WS-VAR-005 - 19.
                  COMPUTE WS-VAR-005 = WS-VAR-006 + 45.
                  COMPUTE WS-VAR-006 = WS-VAR-007 + 38.
                  COMPUTE WS-VAR-006 = 37.
                  COMPUTE WS-VAR-007 = WS-VAR-008 + 23.
                  COMPUTE WS-VAR-007 = 77.
                  COMPUTE WS-VAR-008 = WS-VAR-009 * 68.
                  COMPUTE WS-VAR-009 = WS-VAR-010 * 23.
                  COMPUTE WS-VAR-010 = WS-VAR-011 + 21.
                  COMPUTE WS-VAR-010 = 50.
                  COMPUTE WS-VAR-011 = WS-VAR-012 + 57.
                  COMPUTE WS-VAR-012 = WS-VAR-013 + 18.
                  COMPUTE WS-VAR-013 = WS-VAR-014 - 40.           STOP RUN.
