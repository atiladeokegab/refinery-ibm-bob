       ...
       MAIN-LOGIC.
                  ...
                  COMPUTE WS-VAR-001 = 57.
                  COMPUTE WS-VAR-002 = WS-VAR-003 - 69.
                  COMPUTE WS-VAR-002 = 44.
                  COMPUTE WS-VAR-003 = WS-VAR-004 - 22.
                  COMPUTE WS-VAR-004 = WS-VAR-005 - 83.
                  COMPUTE WS-VAR-005 = WS-VAR-006 + 3.
                  COMPUTE WS-VAR-006 = WS-VAR-007 + 75.
                  COMPUTE WS-VAR-007 = WS-VAR-008 - 18.
                  COMPUTE WS-VAR-008 = WS-VAR-009 - 36.
                  COMPUTE WS-VAR-009 = WS-VAR-010 * 23.
                  COMPUTE WS-VAR-009 = 63.
                  COMPUTE WS-VAR-010 = WS-VAR-011 + 1.
                  COMPUTE WS-VAR-011 = WS-VAR-012 * 65.           STOP RUN.
