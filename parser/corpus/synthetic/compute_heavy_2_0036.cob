       ...
       MAIN-LOGIC.
                  ...
                  COMPUTE WS-VAR-001 = WS-VAR-002 - 40.
                  COMPUTE WS-VAR-002 = WS-VAR-003 - 86.
                  COMPUTE WS-VAR-003 = WS-VAR-004 * 35.
                  COMPUTE WS-VAR-004 = WS-VAR-005 + 35.
                  COMPUTE WS-VAR-004 = 37.
                  COMPUTE WS-VAR-005 = WS-VAR-006 + 1.
                  COMPUTE WS-VAR-005 = 24.
                  COMPUTE WS-VAR-006 = WS-VAR-007 - 42.
                  COMPUTE WS-VAR-007 = WS-VAR-008 * 97.           STOP RUN.
