       ...
       MAIN-LOGIC.
                  ...
                  COMPUTE WS-VAR-002 = WS-VAR-003 - 79.
                  COMPUTE WS-VAR-003 = WS-VAR-004 * 33.
                  COMPUTE WS-VAR-003 = 41.
                  COMPUTE WS-VAR-004 = WS-VAR-005 + 21.
                  COMPUTE WS-VAR-005 = WS-VAR-006 + 81.
                  COMPUTE WS-VAR-005 = 56.
                  COMPUTE WS-VAR-006 = WS-VAR-007 * 82.
                  COMPUTE WS-VAR-006 = 27.
                  COMPUTE WS-VAR-007 = WS-VAR-008 * 65.
                  COMPUTE WS-VAR-008 = WS-VAR-009 + 91.
                  COMPUTE WS-VAR-009 = WS-VAR-010 * 50.
                  COMPUTE WS-VAR-010 = WS-VAR-011 * 18.
                  COMPUTE WS-VAR-011 = WS-VAR-012 + 93.           STOP RUN.
