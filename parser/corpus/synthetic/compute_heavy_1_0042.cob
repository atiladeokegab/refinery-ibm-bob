       ...
       MAIN-LOGIC.
                  ...
                  COMPUTE WS-VAR-001 = WS-VAR-002 + 74.
                  COMPUTE WS-VAR-002 = WS-VAR-003 + 79.
                  COMPUTE WS-VAR-003 = WS-VAR-004 * 21.
                  COMPUTE WS-VAR-003 = 52.
                  COMPUTE WS-VAR-004 = WS-VAR-005 + 60.
                  COMPUTE WS-VAR-005 = WS-VAR-006 + 18.
                  COMPUTE WS-VAR-006 = WS-VAR-007 * 24.
                  COMPUTE WS-VAR-007 = WS-VAR-008 + 40.
                  COMPUTE WS-VAR-008 = WS-VAR-009 - 55.
                  COMPUTE WS-VAR-009 = WS-VAR-010 - 71.
                  COMPUTE WS-VAR-009 = 79.           STOP RUN.
