       ...
       PROCEDURE DIVISION.
       MAIN-LOGIC.
                  COMPUTE WS-VAR-000 = WS-VAR-001 * 88.
                  COMPUTE WS-VAR-001 = WS-VAR-002 - 69.
                  COMPUTE WS-VAR-001 = 74.
                  COMPUTE WS-VAR-002 = WS-VAR-003 + 7.
                  COMPUTE WS-VAR-003 = WS-VAR-004 - 72.
                  COMPUTE WS-VAR-004 = WS-VAR-005 - 81.
                  COMPUTE WS-VAR-005 = WS-VAR-006 + 63.
                  ...
                  COMPUTE WS-VAR-010 = WS-VAR-011 - 68.
                  COMPUTE WS-VAR-011 = WS-VAR-012 + 87.           STOP RUN.
