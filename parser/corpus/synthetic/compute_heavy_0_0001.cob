       ...
       MAIN-LOGIC.
                  ...
                  COMPUTE WS-VAR-006 = WS-VAR-007 + 38.
                  COMPUTE WS-VAR-006 = 24.
                  COMPUTE WS-VAR-007 = WS-VAR-008 * 5.
                  COMPUTE WS-VAR-008 = WS-VAR-009 - 34.
                  COMPUTE WS-VAR-008 = 87.
                  COMPUTE WS-VAR-009 = WS-VAR-010 + 97.
                  COMPUTE WS-VAR-010 = WS-VAR-011 + 5.
                  COMPUTE WS-VAR-011 = WS-VAR-012 * 70.
                  COMPUTE WS-VAR-012 = WS-VAR-013 * 91.
                  COMPUTE WS-VAR-012 = 31.
                  COMPUTE WS-VAR-013 = WS-VAR-014 * 28.
                  COMPUTE WS-VAR-014 = WS-VAR-015 * 54.
                  COMPUTE WS-VAR-014 = 64.           STOP RUN.
