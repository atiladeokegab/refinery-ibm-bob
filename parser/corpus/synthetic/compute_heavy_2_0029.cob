       ...
       MAIN-LOGIC.
                  ...
                  COMPUTE WS-VAR-001 = 89.
                  COMPUTE WS-VAR-002 = WS-VAR-003 * 11.
                  COMPUTE WS-VAR-002 = 17.
                  COMPUTE WS-VAR-003 = WS-VAR-004 + 73.
                  COMPUTE WS-VAR-004 = WS-VAR-005 - 47.
                  COMPUTE WS-VAR-005 = WS-VAR-006 + 27.
                  COMPUTE WS-VAR-006 = WS-VAR-007 + 1.
                  COMPUTE WS-VAR-006 = 73.
                  COMPUTE WS-VAR-007 = WS-VAR-008 * 40.           STOP RUN.
