       ...
       PROCEDURE DIVISION.
       MAIN-LOGIC.
                  COMPUTE WS-VAR-000 = WS-VAR-001 - 65.
                  COMPUTE WS-VAR-001 = WS-VAR-002 + 21.
                  COMPUTE WS-VAR-002 = WS-VAR-003 + 59.
                  COMPUTE WS-VAR-003 = WS-VAR-004 * 12.
                  COMPUTE WS-VAR-004 = WS-VAR-005 + 24.
                  COMPUTE WS-VAR-005 = WS-VAR-006 + 71.
                  COMPUTE WS-VAR-006 = WS-VAR-007 - 5.
                  COMPUTE WS-VAR-007 = WS-VAR-008 + 39.
                  COMPUTE WS-VAR-008 = WS-VAR-009 - 94.
                  COMPUTE WS-VAR-009 = WS-VAR-010 * 26.
                  COMPUTE WS-VAR-010 = WS-VAR-011 * 30.           STOP RUN.
