       ...
       PROCEDURE DIVISION.
       MAIN-LOGIC.
                  COMPUTE WS-VAR-000 = WS-VAR-001 * 78.
                  COMPUTE WS-VAR-001 = WS-VAR-002 * 94.
                  COMPUTE WS-VAR-001 = 97.
                  COMPUTE WS-VAR-002 = WS-VAR-003 - 78.
                  COMPUTE WS-VAR-003 = WS-VAR-004 * 82.
                  COMPUTE WS-VAR-004 = WS-VAR-005 + 97.
                  COMPUTE WS-VAR-005 = WS-VAR-006 * 54.
                  COMPUTE WS-VAR-005 = 26.
                  COMPUTE WS-VAR-006 = WS-VAR-007 * 59.
                  COMPUTE WS-VAR-006 = 60.
                  COMPUTE WS-VAR-007 = WS-VAR-008 - 43.
                  COMPUTE WS-VAR-008 = WS-VAR-009 * 2.           STOP RUN.
