       ...
       PROCEDURE DIVISION.
       MAIN-LOGIC.
                  COMPUTE WS-VAR-000 = WS-VAR-001 - 38.
                  COMPUTE WS-VAR-001 = WS-VAR-002 - 92.
                  COMPUTE WS-VAR-002 = WS-VAR-003 - 28.
                  COMPUTE WS-VAR-003 = WS-VAR-004 + 13.
                  COMPUTE WS-VAR-004 = WS-VAR-005 * 97.
                  COMPUTE WS-VAR-005 = WS-VAR-006 - 24.
                  COMPUTE WS-VAR-005 = 18.
                  COMPUTE WS-VAR-006 = WS-VAR-007 - 30.
                  COMPUTE WS-VAR-007 = WS-VAR-008 - 82.
                  COMPUTE WS-VAR-008 = WS-VAR-009 - 96.
                  COMPUTE WS-VAR-008 = 93.
                  COMPUTE WS-VAR-009 = WS-VAR-010 * 77.
                  COMPUTE WS-VAR-010 = WS-VAR-011 - 94.
                  COMPUTE WS-VAR-011 = WS-VAR-012 * 97.
                  COMPUTE WS-VAR-012 = WS-VAR-013 * 81.
                  COMPUTE WS-VAR-012 = 80.
                  COMPUTE WS-VAR-013 = WS-VAR-014 * 82.
                  COMPUTE WS-VAR-013 = 40.
                  COMPUTE WS-VAR-014 = WS-VAR-015 - 51.
                  COMPUTE WS-VAR-014 = 46.           STOP RUN.
