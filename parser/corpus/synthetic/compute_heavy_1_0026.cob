       ...
       MAIN-LOGIC.
                  ...
                  COMPUTE WS-VAR-001 = 87.
                  COMPUTE WS-VAR-002 = WS-VAR-003 * 15.
                  COMPUTE WS-VAR-002 = 83.
                  COMPUTE WS-VAR-003 = WS-VAR-004 - 81.
                  COMPUTE WS-VAR-004 = WS-VAR-005 * 97.
                  COMPUTE WS-VAR-004 = 75.
                  COMPUTE WS-VAR-005 = WS-VAR-006 - 3.
                  COMPUTE WS-VAR-006 = WS-VAR-007 * 50.
                  COMPUTE WS-VAR-007 = WS-VAR-008 - 23.
                  COMPUTE WS-VAR-008 = WS-VAR-009 + 13.
                  COMPUTE WS-VAR-009 = WS-VAR-010 * 43.
                  COMPUTE WS-VAR-009 = 87.
                  COMPUTE WS-VAR-010 = WS-VAR-011 * 60.
                  COMPUTE WS-VAR-011 = WS-VAR-012 * 64.
                  COMPUTE WS-VAR-012 = WS-VAR-013 + 93.
                  COMPUTE WS-VAR-013 = WS-VAR-014 * 52.
                  COMPUTE WS-VAR-013 = 63.
                  COMPUTE WS-VAR-014 = WS-VAR-015 + 35.
                  COMPUTE WS-VAR-014 = 49.           STOP RUN.
