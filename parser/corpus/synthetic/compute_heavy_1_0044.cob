       ...
       MAIN-LOGIC.
                  ...
                  COMPUTE WS-VAR-001 = WS-VAR-002 + 79.
                  COMPUTE WS-VAR-001 = 28.
                  COMPUTE WS-VAR-002 = WS-VAR-003 * 59.
                  COMPUTE WS-VAR-003 = WS-VAR-004 * 14.
                  COMPUTE WS-VAR-003 = 7.
                  COMPUTE WS-VAR-004 = WS-VAR-005 + 59.
                  COMPUTE WS-VAR-005 = WS-VAR-006 - 72.
                  COMPUTE WS-VAR-006 = WS-VAR-007 + 51.
                  COMPUTE WS-VAR-007 = WS-VAR-008 - 92.
                  COMPUTE WS-VAR-008 = WS-VAR-009 - 92.
                  COMPUTE WS-VAR-009 = WS-VAR-010 - 50.
                  COMPUTE WS-VAR-010 = WS-VAR-011 + 38.
                  COMPUTE WS-VAR-010 = 24.
                  COMPUTE WS-VAR-011 = WS-VAR-012 + 58.
