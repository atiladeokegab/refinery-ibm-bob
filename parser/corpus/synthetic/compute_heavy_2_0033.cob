       ...
       PROCEDURE DIVISION.
       MAIN-LOGIC.
                  COMPUTE WS-VAR-000 = WS-VAR-001 - 92.
                  COMPUTE WS-VAR-001 = WS-VAR-002 + 24.
                  COMPUTE WS-VAR-002 = WS-VAR-003 * 45.
                  COMPUTE WS-VAR-002 = 56.
                  COMPUTE WS-VAR-003 = WS-VAR-004 * 71.
                  COMPUTE WS-VAR-004 = WS-VAR-005 - 14.
                  COMPUTE WS-VAR-004 = 1.
                  COMPUTE WS-VAR-005 = WS-VAR-006 + 81.
                  COMPUTE WS-VAR-006 = WS-VAR-007 + 8.
                  COMPUTE WS-VAR-007 = WS-VAR-008 * 28.           STOP RUN.
