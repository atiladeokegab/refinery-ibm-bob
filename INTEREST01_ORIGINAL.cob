      ...
      *--- AMORTISATION ACCUMULATORS - NO COMP-3 (ANTI-PATTERN) ---
       01  WS-TOTAL-INTEREST    PIC 9(11)V99   VALUE ZEROS.
       01  WS-TOTAL-REPAID      PIC 9(11)V99   VALUE ZEROS.
       01  WS-RUNNING-BALANCE   PIC 9(9)V99    VALUE ZEROS.
       01  WS-INTEREST-PORTION  PIC 9(9)V99    VALUE ZEROS.
       01  WS-PRINCIPAL-PORTION PIC 9(9)V99    VALUE ZEROS.
       01  WS-CUMUL-INTEREST    PIC 9(11)V99   VALUE ZEROS.
       01  WS-CUMUL-PRINCIPAL   PIC 9(11)V99   VALUE ZEROS.
      ...
      *--- DEAD STORAGE - UNREFERENCED (ANTI-PATTERN) ---
       01  WS-UNUSED-RATE-COPY  PIC 9V9999     VALUE ZEROS.
       01  WS-SCRATCH-AMT       PIC 9(7)V99    VALUE ZEROS.
       01  WS-LEGACY-TERM       PIC 9(3)       VALUE ZEROS.
