IDENTIFICATION DIVISION.
       ...
       GET-CURRENT-DATETIME.
           ...
           MOVE WS-YEAR   TO WS-DATE-STRING(1:4)
           MOVE '/'       TO WS-DATE-STRING(5:1)
           MOVE WS-MONTH  TO WS-DATE-STRING(6:2)
           MOVE '/'       TO WS-DATE-STRING(8:1)
           MOVE WS-DAY    TO WS-DATE-STRING(9:2)
           MOVE WS-HOUR   TO WS-TIME-STRING(1:2)
           MOVE ':'       TO WS-TIME-STRING(3:1)
           MOVE WS-MINUTE TO WS-TIME-STRING(4:2)
           MOVE ':'       TO WS-TIME-STRING(6:1)
           MOVE WS-SECOND TO WS-TIME-STRING(7:2).