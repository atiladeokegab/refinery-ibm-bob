      ...
      *--- NUMERIC ACCUMULATORS - PERFORMANCE ANTI-PATTERN: NO COMP-3 ---
       01  WS-TOTAL-GROSS       PIC 9(13)V99 VALUE ZEROS.
       01  WS-TOTAL-TAX         PIC 9(11)V99 VALUE ZEROS.
       01  WS-TOTAL-NI-EMP      PIC 9(11)V99 VALUE ZEROS.
       01  WS-TOTAL-NI-EMPLR    PIC 9(11)V99 VALUE ZEROS.
       01  WS-TOTAL-PENSION-EMP PIC 9(11)V99 VALUE ZEROS.
       01  WS-TOTAL-NET         PIC 9(13)V99 VALUE ZEROS.
       01  WS-YTD-GROSS         PIC 9(13)V99 VALUE ZEROS.
       01  WS-YTD-TAX           PIC 9(11)V99 VALUE ZEROS.
       01  WS-DEPT-GROSS        PIC 9(11)V99 VALUE ZEROS.
       01  WS-RUN-TOTAL-NET     PIC 9(13)V99 VALUE ZEROS.

      *--- DEAD STORAGE - UNREFERENCED VARIABLES (PERFORMANCE ANTI-PATTERN) ---
       01  WS-UNUSED-COUNTER    PIC 9(5)  VALUE ZEROS.
       01  WS-LEGACY-BATCH-ID   PIC X(8)  VALUE SPACES.
       01  WS-SCRATCH-DATE      PIC 9(8)  VALUE ZEROS.
       01  WS-OLD-TAX-PERIOD    PIC X(6)  VALUE SPACES.
       01  WS-PREV-RUN-FLAG     PIC X(1)  VALUE 'N'.
       01  WS-UNUSED-AMOUNT     PIC 9(7)V99 VALUE ZEROS.
